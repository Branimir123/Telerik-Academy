...
VALUES 
('Doncho', 'Minkov', '999999'),
('Evlogi', 'Hristov', '187465'),
('RandomGuy', 'Ivanov', '989145'),
('RandomGirl', 'Ivanova', '3458274')
GO
...
CREATE FUNCTION ufn_CheckStringContains (@stringToCheck nvarchar(50), @letters nvarchar(50)) 
RETURNS INT
AS
BEGIN
	DECLARE @i int =1 
